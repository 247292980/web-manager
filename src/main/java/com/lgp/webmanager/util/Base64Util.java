...
public class Base64Util {
	 ...
	 * within the Base64Util alphabet.
	 * 
	 * @param arrayOctect
	 *            byte array to test
	 * @return true if all bytes are valid characters in the Base64Util alphabet or
	 ...
	 * @param binaryData
	 *            binary data to encode
	 * @return Base64Util characters chunked in 76 character blocks
	 */
	...
	/**
	 * Decodes a byte[] containing containing characters in the Base64Util alphabet.
	 * 
	 * @param pArray
	 *            A byte array containing Base64Util character data
	 ...
	 * @return Base64Util-encoded data.
	 */
	 ...
	 * 
	 * @param base64Data
	 *            Byte array containing Base64Util data
	 * @return Array containing decoded data.
	 */
	public static byte[] decodeBase64(byte[] base64Data) {
		// RFC 2045 requires that we discard ALL non-Base64Util characters
	 ...
	 * characters in the Base64Util alphabet.
	 * 
	 * @param pArray
	 *            a byte array containing binary data
	 * @return A byte array containing only Base64Util character data
	 */
